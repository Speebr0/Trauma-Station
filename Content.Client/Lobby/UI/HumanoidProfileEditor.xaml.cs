...
namespace Content.Client.Lobby.UI
{
    ...
    public sealed partial class HumanoidProfileEditor : BoxContainer
    {
            ...
            MarkingManager markings)
        {
            ...
            _cfgManager.OnValueChanged(TraumaCVars.HeightSliders, OnHeightSlidersChanged, true); // Traumastation
        ...
        {
            _cfgManager.UnsubValueChanged(TraumaCVars.HeightSliders, OnHeightSlidersChanged); // Traumastation
        }
